...
<table width="70%" border="0" cellpadding="0" cellspacing="1" align="center">
    <tr height="50px">
        <td bgcolor="#76EEC6" align="center" width="105px">
            <input type="checkbox" name="boxname" id="all" onclick="cli('boxname')" value="checkbox"/>
        </td>
        <td bgcolor="#76EEC6" align="center" width="10%">留言编号</td>
        <td bgcolor="#76EEC6" align="center" width="10%">员工编号</td>
        <td bgcolor="#76EEC6" align="center" width="10%">员工姓名</td>
        <td bgcolor="#76EEC6" align="center" width="40%">留言内容</td>
        <td bgcolor="#76EEC6" align="center" width="10%">修改</td>
        <td bgcolor="#76EEC6" align="center" width="10%">删除</td>
    </tr>
</table>
<table width="70%" border="0" cellpadding="0" cellspacing="1" id="blocks" align="center">
    ...
    <tr>
        <td bgcolor="#EED8AE" align="center">
            <input type="checkbox" name="boxname" value="<%=dialog.getDno()%>"/>
        </td>
        <td bgcolor="#EED8AE" align="center" width="10%"><%=dialog.getDno() %>
        </td>
        <td bgcolor="#EED8AE" align="center" width="10%"><%=dialog.getNo() %>
        </td>
        <td bgcolor="#EED8AE" align="center" width="10%"><%=dialog.getName() %>
        </td>
        <td bgcolor="#EED8AE" width="40%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=dialog.getMessage() %>
        </td>
        <%if (No == dialog.getNo()) {%>
        <td bgcolor="#EED8AE" align="center" width="10%">
            <!-- <a href="servlet?dno=<%=dialog.getDno()%>&key=update">修改</a> -->
            <input type="button" value="修改" onclick="change(<%=dialog.getDno() %>)">
        </td>
        <%} else {%>
        <td bgcolor="#EED8AE" align="center" width="10%">X</td>
        <%} %>
        <td bgcolor="#EED8AE" align="center" width="10%">
            <!-- <a href="<%=basePath%>servlet?dno=<%=dialog.getDno()%>&key=delete">删除</a> -->
            <input type="button" value="删除" onclick="deleteMessage(<%=dialog.getDno()%>)">
        </td>
    </tr>
    <%} %>
    <tr height="50px">
...
<script type="text/javascript">
    ...
    function readByNo() {
        ...
        if (no === "") {
            ...
            if (isNo(no) === true) {
                window.location.href = "<%=basePath%>servlet?key=readByno&no=" + no;
            } else {
                alert("请输入数字!");
            }
        }
