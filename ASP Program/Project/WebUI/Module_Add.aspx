<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Module_Add.aspx.cs" Inherits="WebUI.Module_Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table align="center" border="0" cellpadding="0" cellspacing="0" class="TableCss"
        ...
        <tr>
            <td colspan="1" style="font-size: 14pt; width: 311px; height: 31px"></td>
            <td colspan="2" style="font-size: 14pt; height: 31px; text-align: center">
                <br />
                <span style="color: #0033ff; font-family: 仿宋_GB2312"></span>
            </td>
            <td colspan="1" style="font-size: 14pt; width: 336px; height: 31px"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width: 311px; height: 30px"></td>
            ...
            <td style="width: 336px; height: 30px"></td>
        </tr>
        <tr>
            <td style="width: 311px"></td>
        ...
        <tr>
            <td style="width: 311px; height: 34px"></td>
            <td style="width: 82px; height: 34px"></td>
            <td colspan="1" style="width: 170px; height: 34px; text-align: left"></td>
